...
export default function AuthPage() {
  ...
  function getSegClass(index: number) {
    const score = getStrength(signupPassword);
    if (index >= score || !signupPassword) return 'strength-seg';
  ...
  async function handleResend() {
    ...
    try {
      ...
      else { setSuccess('New code sent!'); setResendCooldown(60); setOtp(['','','','','','']); }
    } catch {
      setError('Network error. Please try again.');
    }
  }
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tab-bar {
          ...
          margin: 40px auto 0; background: var(--dark2);
        ...
        .card-wrap {
          ...
          max-width: 440px; margin: 24px auto 40px; padding: 0 16px;
        }
        .card {
        ...
        .custom-checkbox {
          ...
          border-radius: 5px; background: var(--dark3);
          display: flex; align-items: center; justify-content: center;
        ...
        .forgot {
          font-size: 12px; color: var(--cyan); letter-spacing: 0.5px;
        ...
        .btn-submit {
          ...
          color: var(--dark); cursor: pointer; transition: all 0.3s;
        ...
        .btn-social {
          ...
          gap: 10px; transition: all 0.3s; margin-bottom: 10px;
        }
        ...
        .otp-input {
          ...
          border-radius: 10px; color: var(--cyan); outline: none;
          transition: all 0.3s; caret-color: var(--cyan);
          padding: 0;
        }
        .otp-input:focus {
          border-color: var(--cyan);
        ...
        .verify-sub { font-size: 13px; color: var(--text-muted); margin-bottom: 4px; line-height: 1.6; }
              ...
              <div className="input-group">
                ...
                <div className="input-wrap">
                  <input type="password" placeholder="••••••••" value={signupPassword}
                    onChange={e => { setSignupPassword(e.target.value); setPassword(e.target.value); }} />
                  <span className="input-icon">🔒</span>
                </div>
          ...
          {view === 'verify' && (
            <div>
              ...
              <div className="verify-sub">
                ...
                <span className="verify-email">{pendingEmail}</span>.<br />
